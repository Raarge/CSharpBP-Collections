...
namespace Acme.Biz
{
    ...
    public class Product
    {
        ...
        public Product()
        {
            ...
            // below is collection initializer
            string[] colorOptions = {"Red", "Espresso", "White", "Navy"};
            
            var brownIndex = Array.IndexOf(colorOptions, "Espresso");  // using the IndexOf for an array
        ...
        // C# 6 method but has no guard methods instead we will revert back to old method  see below method
